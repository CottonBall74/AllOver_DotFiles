...
local pathToAwesome = "/home/halls/.config/awesome/"
...
local function worker(user_args)
    ...
    local path_to_icon = args.path_to_icon or pathToAwesome..'Icons/system/brightness.svg'
    ...
    local color = args.color or beautiful.custom_bg_focus
