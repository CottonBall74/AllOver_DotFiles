...
local function worker(user_args)
    ...
    local font = args.font or 'jetbrains mono 10'
    ...
    local good_level_color = args.good_level_color or '#7FA6C1'
    local charging_color = args.charging_color or '#43a047'
    local normal_color = args.normal_color or '#7FA6C1'

    local warning_msg_title = args.warning_msg_title or 'ummm...'
    local warning_msg_text = args.warning_msg_text or 'Battery is dying'
    local warning_msg_position = args.warning_msg_position or 'top_right'
    local warning_msg_icon = args.warning_msg_icon or HOME .. "/.config/awesome/Images/low_battery.jpg"
    ...
    local function update_widget(widget, stdout)
        ...
        elseif charge > 50 and charge <= 100 then
            widget.colors = { good_level_color }
        else
